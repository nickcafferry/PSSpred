...
<script src="http://nickcafferry.github.io/github-comments/gc.js"></script>
<div class="gc-comments" data-repos="nickcafferry/github-comments" data-issues="1" >
    <div class="gc-comments-title">
        评论
    </div>
    <div class="gc-comments-info">
        想在此留下评论，请访问 <a href="{{issues_link}}">{{https://github.com/nickcafferry/Working-of-an-acid-buffer/edit/master/README.md}}</a> 提交评论
    </div>
</div>
